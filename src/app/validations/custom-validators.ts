...
export class CustomValidator {
   ...
   */
  static ValidYearFounded(c: AbstractControl): ValidationErrors {
   ...
   * @param c abstract control
   */
  static isNumber(c: AbstractControl): ValidationErrors {
  ...
  static ValidaTime(c: AbstractControl): ValidationErrors {
